...
RUN wget https://github.com/StuartLox/terraform-provider-aws/releases/download/v${TERRAFORM_AWS_VERSION}/darwin_amd64.zip

RUN unzip linux_amd64.zip

RUN chmod +x terraform-provider-aws_*
